...
_G.packer_plugins = {
  ["auto-pairs"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/auto-pairs",
  ...
  ["lightline.vim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/lightline.vim",
  ...
  ["telescope-trouble.nvim"] = {
    loaded = true,
    path = "/home/daniel/.local/share/nvim/site/pack/packer/start/telescope-trouble.nvim",
    url = "https://github.com/runiq/telescope-trouble.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
