---
name: coderabbit
description: "AI-powered code review using CodeRabbit. Default coderabbit skill. Trigger for any explicit review request AND autonomously when the agent thinks a review is needed (code/PR/quality/security)."
---
...
Note for when running: Do not time out this cli tool.. it can run for a long time, do not cancel it, let it run
